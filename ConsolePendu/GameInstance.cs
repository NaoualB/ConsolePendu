   ...
   public class GameInstance
    {
        ...
        public GameInstance(int maxErrors = 5)
        {
            rnd = new Random();
        ...
        /// jusqu'à ce que la partie soit gagné ou perdue (5 erreurs).
        /// </summary>
        public void Play()
        {
            while (!isWin)
            {
                ...
                if (letterIndex != -1)
                {
                    Console.WriteLine("vous avez deja utiliser cette lettre : {0}", letter);
                    Guesses.Add(letter);
                }
                else
                {
